...
if not cap.isOpened():
    ...
    speak("Camera não foi encontrada/Ocorreu um erro")
    exit()
...
def ouvirMicrofone():
    ...
    with sr.Microphone() as mic:
        ...
        while True:  # Loop até que a fala seja entendida
            print("Diga qual objeto você deseja encontrar...")
            speak("Diga qual objeto você deseja encontrar")
            ...
            try:
                ...
                speak("Não entendi, por favor, tente novamente.")
